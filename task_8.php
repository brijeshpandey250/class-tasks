<?php
	...
	*/
		...
		function multiply($argv){
			...
			*/
						...
						if($argv[1] == 'multiply'){
							...
							if(isset($argv[2])){
								...
								*/
								...
								if($checkResult == 1){
									echo "\n"."Write  command as: task_8.php multiply 2,34,5....."."\n\n";
								} else {
			...
			if($errorFlag == 1){
				...
				echo "\n"."Please write  command as: task_8.php multiply 2,3,4,5...."."\n\n";
			}
		}
	...
	// create object of class MultiplyClass
	$obj = new MultiplyClass();
